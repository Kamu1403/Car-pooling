...
Page({
  ...
  into_inform: function () {
    wx.navigateTo({
      url: "/pages/inform/inform?myName=" + this.data.myName //wx.getStorageSync("myUsername")
    });
  },
  ...
  into_info: function (event) {
    wx.navigateTo({
      url: "/pages/friend_info/friend_info?yourname=" + event.target.dataset.username
    });
  },
